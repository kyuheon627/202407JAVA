...
<main class="form-signin w-100 m-auto">
  <form method="post" action="${pageContext.request.contextPath}/edit">
    ...
    <div class="form-floating">
      <input type="email" class="form-control" id="floatingInput" name="email" placeholder="name@example.com" value="${customInfo.email}">
      <label for="floatingInput">Email address</label>
    </div>
    <div class="form-floating">
      <input type="password" class="form-control" id="floatingPassword" name="password" placeholder="Password" value="${customInfo.password}">
      <label for="floatingPassword">Password</label>
    </div>
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingName" name="name" placeholder="name" value="${customInfo.name}">
      <label for="floatingName">User Name</label>
    </div><br>
    <button class="btn btn-primary w-100 py-2" type="submit">Edit</button><br><br>
    
    <button type="button" class="btn btn-primary w-100 py-2" onclick="location.href='deleteMember?member_id=${customInfo.member_id}'">삭제</button>
    <p class="mt-5 mb-3 text-body-secondary">&copy; 2023–2024</p><br>
