...
<body>
	...
	<header>
		<div class="inner">
			<h1>
				<a href="${pageContext.request.contextPath}">DCODLAB</a>
			</h1>

			<ul id="gnb">
				<li><a href="${pageContext.request.contextPath}/list">BOARD</a></li>
				<li><a href="${pageContext.request.contextPath}/listMy">MY BOARD</a></li>
			...
			<ul class="util">
				<c:if test="${userLoggedIn}">
					<li><a href="#">${customInfo.name}님  </a></li>
					<li><a href="${pageContext.request.contextPath}/logout">Logout</a></li>
					<li><a href="${pageContext.request.contextPath}/editForm">Edit</a></li>
				</c:if>
				<c:if test="${!userLoggedIn}">
