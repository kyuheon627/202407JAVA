...
<body>
	...
	<div class="container" style="padding-top: 50;">
		...
		<c:if test="${customInfo.name == msg.writer}">
		...
		<c:if test="${customInfo.name != msg.writer}">
			<button type="button" class="btn btn-outline-secondary" onclick="location.href='back'">수정</button>
			<button type="button" class="btn btn-outline-success" onclick="location.href='back'">삭제</button>
		</c:if>
