...
public class BoardService {
    ...
    public AccountDto loginOne(String id, String pwd) throws Exception {
    	...
    	AccountDto dto = new AccountDao().selectAccount(id, pwd);
    	...
    	if (dto.equals(null)) {
    		...
    		throw new Exception("아이디나 비밀번호가 틀립니다."+id+pwd);
    	}
    }
}